...
class AddressPlainFormatter extends FormatterBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @var \Drupal\sfgov_locations\Repository\AddressFormatRepository
   */
   ...
   * @param \Drupal\sfgov_locations\Repository\AddressFormatRepository $address_format_repository
   *   The address format repository.
