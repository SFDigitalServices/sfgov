function fcalc() {
  ...
  let fCurrentYearAMI = drupalSettings.sfgov.mohcd.calculator.currentYearAMI
  let fBMRValuation
  let fPurchaseYearSelect = document.getElementById("purchaseYear")
  let fPurchasePrice = document.getElementById("purchasePrice").value
  let fPurchaseYearAMI = parseFloat(fPurchaseYearSelect.value)
  let fPurchaseYear = parseInt(fPurchaseYearSelect.options[fPurchaseYearSelect.selectedIndex].text)
  let fFieldError = new Boolean()
  let fFieldErrorArray = new Array()
