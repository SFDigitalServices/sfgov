      ...
      if ($(window).width() >= mobileSize) {
        ...
        if (stitle == true) {
          ...
          $('.sfgov-services-section .sfgov-services').each(function () {
            ...
            if ($(this).find('.sfgov-dept-services-section-content').parent()
              .hasClass('details__content')) {
        ...
        if (rtitle == true) {
          ...
          $('.sfgov-resources .paragraph--type--other-info-card').each(function () {
            console.log($(this))
            if ($(this).find('.__resources').parent()
              .hasClass('details__content')) {
        ...
        if (stitle == true) {
          ...
          $('.views-element-container .sfgov-services').each(function () {
            ...
            if ($(this).find('.sfgov-container-three-column').parent()
              .hasClass('details__content')) {
