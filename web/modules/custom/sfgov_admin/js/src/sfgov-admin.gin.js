  ...
  Drupal.behaviors.sfgovAdminSidebarToggle = {
    attach: function (context) {
      ...
      $('.layout-region-node-secondary', context).once('sidebarToggle')
        ...
        .prepend('<button id="sidebar-toggle" class="sidebar-toggle"><span class="sidebar-toggle__text">' + Drupal.t('Toggle sidebar') + '</span><span class="sidebar-toggle__icon sidebar-toggle-x"></span></button>');
