...
class MigrateEckDeriverTest extends MigrateEckTestBase {
   ...
   * {@inheritdoc}
   */
  public static $modules = ['eck', 'node'];
  ...
  public function testDeriver() {
    ...
    $this->assertIdentical('field_text', $process['field_text'][0]['source']);
    $this->assertIdentical('field_simple_entities', $process['field_simple_entities'][0]['source']);
    $this->assertIdentical('field_node', $process['field_node'][0]['source']);
    $this->assertIdentical('field_complex_entity', $process['field_complex_entity'][0]['source']);
