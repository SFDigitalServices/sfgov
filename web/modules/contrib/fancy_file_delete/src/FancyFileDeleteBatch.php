...
class FancyFileDeleteBatch {
  ...
  public function setBatch($values, $force, $ui = TRUE) {
    ...
    $batch_builder
      ->setTitle(t('Deleting Files...'))
      ->setInitMessage(t('Fun Stuff is Happening...'))
      ->setErrorMessage(t('Fancy File Delete has encountered an error.'))
  ...
  public function process($fid, $force, &$context) {
    ...
    $context['message'] = t('Now cleansing the system of fid#%fid', ['%fid' => $fid]);
  }
