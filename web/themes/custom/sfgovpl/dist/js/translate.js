function SFGovTranslate() {
  ...
  this.sfgovGTranslate = function (event) {
    ...
    $('body').find('*').not('script, noscript, link, style, iframe, .goog-te-combo').removeClass((i, classNames) => {
      return classNames.split(' ').filter(klass => klass.includes('sfgov-translate-lang-')).join(' ');
    });
