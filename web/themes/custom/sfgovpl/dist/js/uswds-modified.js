...
(function () {
  ...
  16: [function (require, module, exports) {
    ...
    var PREFIX = require('../config').prefix; // XXX match .usa-accordion and .usa-accordion-bordered
    ...
    var toggleButton = function toggleButton(button, expanded) {
      ...
      expanded = toggle(button, expanded); // XXX multiselectable is opt-in, to preserve legacy behavior
