...
(function ($) {
  ...
  function replaceSpecialChars(str) {
    var specialChars = ['(', ')', '[', ']', '{', '}', '|', '\\', '?', '+', '$', '^', '*', '!'];
    var specialCharsRegexStr = '[\\' + specialChars.join('\\') + ']'; // var specialCharsRegex = /[\(\)\[\]\{\}\|\\\?\+\$\^\*\!]/g;
  ...
  $('.sfgov-service-a-z').each(function () {
    ...
    var regexStr = ''; // loop through the sort title words and create a regular expression to match and replace for highlighting the sorted phrase in the actual title
