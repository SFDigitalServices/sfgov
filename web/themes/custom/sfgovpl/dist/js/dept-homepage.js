...
(function ($) {
  $('body.page-node-type-department').each(function () {
    ...
    var sections = [{
      "selector": "#sfgov-dept-services",
      "label": "Services"
    }, {
      "selector": "#sfgov-dept-news",
      "label": "News"
    }, {
      "selector": "#sfgov-dept-events",
      "label": "Events"
    }, {
      "selector": "#sfgov-dept-resources",
      "label": "Resources"
    }, {
      "selector": "#sfgov-dept-about",
      "label": "About"
    }, {
      "selector": "#sfgov-dept-contact",
      "label": "Contact"
    }];
    ...
    for (var i = 0; i < sections.length; i++) {
      var elem = $(sections[i].selector); // console.log(sections[i]);
