(function ($, window, Drupal) {
  Drupal.behaviors.meetings = {
    attach(context) {
      ...
      const $buttonShow = $('<button />').addClass('filter-toggle filter-toggle--show').append('<span>' + Drupal.t('Show filters') + '</span>');

      const $buttonHide = $('<button />').addClass('filter-toggle filter-toggle--hide').append('<span>' + Drupal.t('Hide filters') + '</span>');
