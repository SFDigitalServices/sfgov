...
/*
 * Enable local sessions to ensure that SimpleSAMLphp can
 * keep a session when used in standalone mode
...
$config = array(
     ...
     * root directory.
     */
    'certdir' => $_ENV['HOME'] . '/code/web/private/',
    'loggingdir' => $_ENV['HOME'] . '/logs/',
    'datadir' => 'data/',
     ...
     */
    'secretsalt' => '9l7ovgbg2yda22ggn5lor4hsr7384j72',
     ...
     */
    'auth.adminpassword' => 'sfds_saml_login_10!',
     ...
     */
    'trusted.url.domains' => array('idcs-28d2cb948ab8484aaeb29f302ed52c7d.identity.oraclecloud.com'),
